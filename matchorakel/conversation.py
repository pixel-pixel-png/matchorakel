...
def friendly_reply(message, history=None):
    ...
    if re.fullmatch(r'(bra|bra tack|jo tack bra|joda det ar bra|det ar bra tack|bra med mig tack|jattebra|toppen|okej|helt okej|sa dar|sadar|inte sa bra|daligt|jag mar bra|jag mar daligt|det ar bra med mig|bra sjalv)', phrase):
